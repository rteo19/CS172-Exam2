...
private:
	string cityName;
	vector<Citizen*> citizens; //vector for number of citizens
	vector<Citizen*> favColor; //vector for the citizens who have the same fav color
	int population = 0; //population for a city set to zero
	string file;
public:
